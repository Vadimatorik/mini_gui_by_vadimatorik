...
struct mini_gui_by_vadimatorik_lcd_mono_play_bar_init_cfg_t {
...
public:
    constexpr mini_gui_by_vadimatorik_lcd_mono_play_bar( const mini_gui_by_vadimatorik_lcd_mono_play_bar_init_cfg_t* const cfg ) : cfg(cfg) {}
...
private:
    ...
    const mini_gui_by_vadimatorik_lcd_mono_play_bar_init_cfg_t* const cfg;
