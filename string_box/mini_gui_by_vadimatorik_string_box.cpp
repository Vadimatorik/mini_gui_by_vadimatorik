...
void mini_gui_by_vadimatorik_lcd_mono_string_box::reset (int number_active, int number_play, int all_string, int current_track) const {
    this->cfg->fill_rect_and_frame( this->cfg->x_pos,
                                    this->cfg->y_pos,
                                    this->cfg->width_string_box_pixel-2,
    ...
    this->cfg->draw_frame( this->cfg->x_pos + this->cfg->width_string_box_pixel - 2 -this->cfg->thickness_slider,
                           this->cfg->y_pos, this->cfg->thickness_slider, this->cfg->height_string_box_pixel, this->cfg->width_line, true );
    // Рисуем сам ползунок.
    this->cfg->fill_rect(
    ...
    for (int loop_string = 0; loop_string < this->cfg->string_number; loop_string++){
        ...
        if ((loop_string == number_active) | (loop_string == (number_play-1))) { // Если мы на выбранной или играющей в данный момент строке.
            this->cfg->fill_rect_and_frame( this->cfg->x_pos, point_y,
                                            this->cfg->width_string_box_pixel - 2 -this->cfg->thickness_slider + this->cfg->width_line,
