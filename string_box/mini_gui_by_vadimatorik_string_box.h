...
struct mini_gui_by_vadimatorik_lcd_mono_string_box_cfg_t {
    ...
    void    (*fill_rect_and_frame) ( const uint8_t& x, uint8_t& y,
                                  ...
                                  const uint8_t& thickness, const uint8_t& color_rect, const uint8_t& color_line );	// Рисуем прямоугольник и его окаймление.
    ...
    const uint16_t	x_pos;                      // Позиция левого верхнего угла бара.
